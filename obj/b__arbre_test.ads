...
package ada_main is
   ...
   Ada_Main_Program_Name : constant String := "_ada_arbre_test" & ASCII.NUL;
   ...
   u00001 : constant Version_32 := 16#1676229e#;
   pragma Export (C, u00001, "arbre_testB");
